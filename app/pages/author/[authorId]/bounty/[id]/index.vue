  ...
  <div v-else-if="bounty" class="container mx-auto px-4 py-8">
    ...
    <div class="flex items-start justify-between mb-8">
      ...
      <div class="flex gap-6 items-start">
        ...
        <div
          v-if="bounty.salaryMin || bounty.salaryMax"
          class="text-right pl-6 border-l border-muted">
          <div class="text-sm text-muted-foreground mb-1">
            Yearly Gross Salary
          </div>
          <div class="text-lg font-semibold text-foreground">
            <template v-if="bounty.salaryMin && bounty.salaryMax">
              ${{ formatSalary(bounty.salaryMin) }} - ${{
                formatSalary(bounty.salaryMax)
              }}
            </template>
            <template v-else-if="bounty.salaryMin">
              From ${{ formatSalary(bounty.salaryMin) }}
            </template>
            <template v-else>
              Up to ${{ formatSalary(bounty.salaryMax) }}
            </template>
          </div>
        </div>
        ...
        <div
          v-if="
            bounty.payoutType === 'PERCENTAGE' &&
            bounty.payoutPercentage &&
            (bounty.salaryMin || bounty.salaryMax)
          "
          class="text-right pl-6 border-l border-muted">
          <div class="text-sm text-muted-foreground mb-1">Potential Payout</div>
          <div class="text-lg font-semibold text-primary">
            <template v-if="bounty.salaryMin && bounty.salaryMax">
              ${{
                formatSalary(
                  (bounty.salaryMin * 12 * bounty.payoutPercentage) / 100
                )
              }}
              - ${{
                formatSalary(
                  (bounty.salaryMax * 12 * bounty.payoutPercentage) / 100
                )
              }}
            </template>
            <template v-else-if="bounty.salaryMin">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div class="lg:col-span-2 space-y-8">
        ...
        <Card>
          <CardHeader>
            <CardTitle>Job Description</CardTitle>image.png
          </CardHeader>
          <CardContent>
            <p
          ...
          <CardContent class="space-y-4">
            ...
            <template v-else-if="isAuthor">
              ...
              <div class="flex flex-col gap-3">
                <div v-if="bounty.tallyFormUrl" class="space-y-3">
                  <div v-if="bounty.tallyFormPassword" class="space-y-2">
                ...
                <Button
                  ...
                  @click="
                    navigateTo(
                      `/author/${bounty.user.id}/bounty/${bountyId}/submissions`
                    )
                  ">
