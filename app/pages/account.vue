<template>
  <div class="container mx-auto px-4 py-8">
    ...
    <div v-if="!user" class="text-center py-16">
      ...
      <p class="text-muted-foreground mb-6">You need to sign in to view your account.</p>
      <NuxtLink to="/sign-in">
    ...
    <div v-else class="max-w-4xl mx-auto">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-8">
            ...
            <CardContent class="space-y-4">
              <div class="flex items-center gap-4">
                ...
                <div>
                  ...
                  <Badge :variant="user.userType === 'COMPANY' ? 'default' : 'secondary'" class="mt-1">
                    {{ user.userType === 'COMPANY' ? 'Company' : 'Recruiter' }}
                  </Badge>
                </div>
              </div>
              ...
              <div class="pt-4 border-t">
                <div class="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    <p class="font-medium text-muted-foreground">Member Since</p>
                    <p>{{ formatDate(user.createdAt) }}</p>
                  </div>
                  <div>
                    <p class="font-medium text-muted-foreground">Email Verified</p>
          ...
          <Card v-if="user.userType === 'COMPANY' && company">
            <CardHeader>
            ...
            <CardContent class="space-y-4">
              <div>
                ...
                <p v-if="company.description" class="text-sm text-muted-foreground mt-1">
                  {{ company.description }}
                </p>
                <a 
              ...
              <div class="pt-4 border-t">
                <div class="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    <p class="font-medium text-muted-foreground">Total Bounties</p>
                    <p class="text-lg font-semibold">{{ companyStats?.totalBounties || 0 }}</p>
                  </div>
                  <div>
                    <p class="font-medium text-muted-foreground">Active Bounties</p>
                    <p class="text-lg font-semibold">{{ companyStats?.activeBounties || 0 }}</p>
                  </div>
                </div>
              </div>
            </CardContent>
          ...
          <Card v-else-if="user.userType === 'RECRUITER' && recruiter">
            <CardHeader>
            ...
            <CardContent class="space-y-4">
              <div>
                ...
                <div v-if="recruiter.experience || recruiter.specialties" class="mt-3 space-y-2">
                  ...
                  <div v-if="recruiter.specialties">
                    <span class="text-xs font-medium text-muted-foreground">Specialties: </span>
              ...
              <div class="pt-4 border-t">
                <div class="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    <p class="font-medium text-muted-foreground">Active Collaborations</p>
                    <p class="text-lg font-semibold">{{ recruiterStats?.totalCollaborations || 0 }}</p>
                  </div>
                  <div>
                    <p class="font-medium text-muted-foreground">Total Submissions</p>
                    <p class="text-lg font-semibold">{{ recruiterStats?.totalSubmissions || 0 }}</p>
                  </div>
                </div>
              </div>
            </CardContent>
        ...
        <div class="space-y-6">
          ...
          <Card>
            ...
            <CardContent class="space-y-3">
              ...
              <NuxtLink v-if="user.userType === 'RECRUITER'" to="/my-bounties" class="block">
                <Button variant="outline" class="w-full justify-start">
                  <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <Card>
            ...
            <CardContent>
              <div class="text-center py-8 text-muted-foreground">
                ...
                <p class="text-xs mt-1">Complete successful hires to earn payouts</p>
              </div>
            </CardContent>
          </Card>
        </div>
